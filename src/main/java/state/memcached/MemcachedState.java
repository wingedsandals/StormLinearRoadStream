/*
*
* Trident Memcached State Library
* by @nathanmarz (Creator of Storm)
*
* This file is protected by Apache License 2.0
*
* */

package state.memcached;
...
public class MemcachedState<T> implements IBackingMap<T> {
    ...
    private void registerMetrics(Map conf, IMetricsContext context) {
      int bucketSize = Integer.parseInt(conf.get(Config.TOPOLOGY_BUILTIN_METRICS_BUCKET_SIZE_SECS).toString());
