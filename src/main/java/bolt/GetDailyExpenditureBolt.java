...
public class GetDailyExpenditureBolt extends BaseFunction implements Function {
	
	TollsPerVehicleDB tollsPerVehicleState;

	public GetDailyExpenditureBolt(TridentTopology topology, TollsPerVehicleDB tollsPerVehicleState) {
...
//        long tod = tuple.getLong(14);
        ...
        Long tolls = tollsPerVehicleState.getTolls(xway, vid, day);
